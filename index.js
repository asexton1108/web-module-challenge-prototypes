...
/* 
  ...
  1. Window Binding - when none of the other rulles apply, this will return the window or global object in node or undefined in strict mode.

  2. Implicit binding - when the function is invoked look to the left of the dot that's what this refers to

  3. Explicity binding - .call, .apply, .bind 
